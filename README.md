...
The script requires dependencies (`psycopg2`, `httpx`, `pillow`) that are only installed inside the watcher container.
You must copy the script in before each run if you have edited it locally.
